...
const base = {
  de: {
    ...
    reviewsSec: {
      ...
      sub: "Bewertungen unserer Fahrgäste – auf Google und per E-Mail.", count: "Bewertungen",
    },
    blogSec: {
      title: "Blog",
    ...
    detail: {
      ...
      confirmNote: "Sie erhalten Ihre Bestätigung in der Regel innert 2 Minuten.",
      total: "Gesamt",
  ...
  en: {
    ...
    reviewsSec: {
      ...
      sub: "Reviews from our passengers – on Google and by email.", count: "reviews",
    },
    blogSec: {
      title: "Blog",
    ...
    detail: {
      ...
      back: "Back",
      sending: "Sending",
      confirmNote: "You will usually receive your confirmation within 2 minutes.",
      total: "Total",
