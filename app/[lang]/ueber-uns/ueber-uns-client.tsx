...
const A = {
  de: {
    ...
    promises: [
      ...
      ["💬", "Einfache Buchung", "Online, per WhatsApp oder Telefon – Festpreisbestätigung innert 2 Minuten, keine Vorauszahlung nötig."],
  ...
  en: {
    ...
    promises: [
      ...
      ["💬", "Easy booking", "Online, via WhatsApp or by phone – fixed-price confirmation within 2 minutes, no prepayment required."],
