    ...
    de: {
      ...
      body: [
        ...
        { h: "Warum ein vorgebuchter Transfer nachts den grössten Unterschied macht", p: [
          "Bei einem vorab gebuchten Transfer wartet Ihr Chauffeur mit Namensschild direkt in der Ankunftshalle – unabhängig davon, ob Sie um 22:40 oder um 00:20 aus dem Zoll kommen. Wir verfolgen Ihren Flug in Echtzeit; verspätet sich die Landung, verschiebt sich die Abholung automatisch. 60 Minuten Wartezeit nach der Landung sind bereits im Festpreis enthalten, und der Festpreis gilt pro Fahrzeug, rund um die Uhr, ohne Nachtzuschlag und ohne Taxameter.",
    ...
    de: {
      ...
      body: [
        ...
        { h: "Was ein Festpreis-Transfer anders macht", p: [
          "Bei einem vorab gebuchten Transfer steht der Preis fest, bevor Sie abfliegen – pro Fahrzeug, unabhängig von Uhrzeit, Stau oder Umweg. Auf unseren Streckenseiten sehen Sie ihn transparent: Flughafen Zürich–Winterthur beispielsweise ab CHF 88.90, Flughafen Zürich–Zug ab CHF 138.69, Flughafen Zürich–Luzern ab CHF 189.75, Flughafen Zürich–Basel ab CHF 258.50 (jeweils Business Class, pro Fahrzeug). Im Preis enthalten sind Meet & Greet in der Ankunftshalle, 60 Minuten Wartezeit nach der Landung, Flugverfolgung und Kindersitze. Es gibt keinen Nachtzuschlag und keine Gepäckgebühr.",
    ...
    en: {
      ...
      body: [
        ...
        { h: "What a fixed-price transfer does differently", p: [
          "With a pre-booked transfer the price is fixed before you depart – per vehicle, regardless of time of day, traffic or detours. On our route pages you see it transparently: Zurich Airport–Winterthur for example from CHF 88.90, Zurich Airport–Zug from CHF 138.69, Zurich Airport–Lucerne from CHF 189.75, Zurich Airport–Basel from CHF 258.50 (each Business Class, per vehicle). Included in the price are meet & greet in the arrivals hall, 60 minutes of waiting time after landing, flight tracking and child seats. There is no night surcharge and no luggage fee.",
