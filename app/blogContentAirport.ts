    ...
    de: {
      ...
      body: [
        ...
        { h: "Was ein Festpreis-Transfer anders macht", p: [
          "Bei einem vorab gebuchten Transfer steht der Preis fest, bevor Sie abfliegen – pro Fahrzeug, unabhängig von Uhrzeit, Stau oder Umweg. Auf unseren Streckenseiten sehen Sie ihn transparent: Flughafen Zürich–Winterthur beispielsweise ab CHF 109.88, Flughafen Zürich–Zug ab CHF 144.36, Flughafen Zürich–Luzern ab CHF 197.24, Flughafen Zürich–Basel ab CHF 261.36 (jeweils Business Class, pro Fahrzeug). Im Preis enthalten sind Meet & Greet in der Ankunftshalle, 60 Minuten Wartezeit nach der Landung, Flugverfolgung und Kindersitze. Es gibt keine Gepäckgebühr; nachts (00–06 Uhr) gilt ein Nachttarif von 20 %, der vor der Buchung sichtbar ist.",
    ...
    en: {
      ...
      body: [
        ...
        { h: "What a fixed-price transfer does differently", p: [
          "With a pre-booked transfer the price is fixed before you depart – per vehicle, regardless of time of day, traffic or detours. On our route pages you see it transparently: Zurich Airport–Winterthur for example from CHF 109.88, Zurich Airport–Zug from CHF 144.36, Zurich Airport–Lucerne from CHF 197.24, Zurich Airport–Basel from CHF 261.36 (each Business Class, per vehicle). Included in the price are meet & greet in the arrivals hall, 60 minutes of waiting time after landing, flight tracking and child seats. There is no luggage fee; at night (midnight to 6 am) a night tariff of 20 % applies and is visible before booking.",
