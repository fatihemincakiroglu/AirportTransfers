        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-16 text-white md:grid-cols-[1.15fr_0.85fr] md:pb-24 md:pt-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="/strecken" className="rounded-full border border-white/40 bg-white/5 px-6 py-3 text-sm font-bold text-white backdrop-blur transition-colors hover:bg-white hover:text-[#0C2E25]">
                {L.hero.cta2} ↗
              </a>
            </div>
