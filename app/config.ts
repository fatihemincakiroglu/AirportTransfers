...
export const routes: { slug: string; to: LocalName; km: number; min: number; price: number; img: string }[] = [
  { slug: "zurich-airport-to-zug", to: "Zug", km: 46.2, min: 55, price: 138.69, img: "/routes/zug.jpg" },
  { slug: "zurich-airport-to-luzern", to: { de: "Luzern", en: "Lucerne" }, km: 63.3, min: 76, price: 189.75, img: "/routes/luzern.jpg" },
  { slug: "zurich-airport-to-basel", to: "Basel", km: 86.2, min: 103, price: 258.5, img: "/routes/basel.jpg" },
  { slug: "zurich-airport-to-geneva", to: { de: "Genf", en: "Geneva" }, km: 266.2, min: 319, price: 798.5, img: "/routes/genf.jpg" },
  { slug: "zurich-airport-to-bern", to: "Bern", km: 117.5, min: 141, price: 352.5, img: "/routes/bern.jpg" },
  ...
  { slug: "zurich-airport-to-lausanne", to: "Lausanne", km: 215.5, min: 259, price: 646.5, img: "/routes/lausanne.jpg" },
  { slug: "zurich-airport-to-montreux", to: "Montreux", km: 243.5, min: 292, price: 730.5, img: "/routes/montreux.jpg" },
  { slug: "zurich-airport-to-lugano", to: "Lugano", km: 210.2, min: 252, price: 630.5, img: "/routes/lugano.jpg" },
  { slug: "zurich-airport-to-grindelwald", to: "Grindelwald", km: 141.7, min: 170, price: 425, img: "/gallery/8.jpg" },
  { slug: "zurich-airport-to-verbier", to: "Verbier", km: 269.8, min: 324, price: 809.5, img: "/routes/verbier.jpg" },
  { slug: "zurich-airport-to-wengen", to: "Wengen", km: 133.5, min: 160, price: 400.5, img: "/gallery/6.jpg" },
  { slug: "zurich-airport-to-st-gallen", to: "St. Gallen", km: 81.2, min: 97, price: 243.5, img: "/routes/st-gallen.jpg" },
  { slug: "zurich-airport-to-chur", to: "Chur", km: 135.5, min: 163, price: 406.5, img: "/routes/chur.jpg" },
  { slug: "zurich-airport-to-winterthur", to: "Winterthur", km: 29.6, min: 36, price: 88.9, img: "/routes/winterthur.jpg" },
  { slug: "zurich-airport-to-locarno", to: "Locarno", km: 201.3, min: 242, price: 604, img: "/routes/locarno.jpg" },
  { slug: "zurich-airport-to-thun", to: "Thun", km: 141.7, min: 170, price: 425, img: "/routes/thun.jpg" },
  { slug: "zurich-airport-to-sion", to: "Sion", km: 270.7, min: 325, price: 812, img: "/routes/sion.jpg" },
  { slug: "zurich-airport-to-bellinzona", to: "Bellinzona", km: 182.7, min: 219, price: 548, img: "/routes/bellinzona.jpg" },
  { slug: "zurich-airport-to-fribourg", to: "Fribourg", km: 154.7, min: 186, price: 464, img: "/routes/fribourg.jpg" },
  { slug: "zurich-airport-to-schaffhausen", to: "Schaffhausen", km: 49.5, min: 59, price: 148.5, img: "/routes/schaffhausen.jpg" },
