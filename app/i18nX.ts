...
const baseX = {
  de: {
    ...
    pay: { title: "Online bezahlen", note: "Sichere Zahlung mit Karte, TWINT, Apple Pay oder Google Pay über Stripe.", cta: "Zur Zahlung", success: "Zahlung erfolgreich", successText: "Vielen Dank! Ihre Zahlung ist eingegangen. Wir prüfen die Verfügbarkeit und bestätigen in der Regel innerhalb von 15 Minuten. Bei einer Absage wird der Betrag sofort vollständig zurückerstattet.", canceled: "Zahlung abgebrochen – Ihre Anfrage wurde nicht abgeschlossen." },
    ...
    done: { title: "Anfrage übermittelt!", body: (r: string) => `Ihre Transferanfrage ${r} ist bei uns eingegangen. Wir prüfen die Verfügbarkeit und melden uns in der Regel innerhalb von 15 Minuten per E-Mail oder Telefon.`, hint: "Vielen Dank für Ihre Anfrage! Bitte prüfen Sie auch Ihren Posteingang bzw. Spam-Ordner.", payment: "Zahlungsart", home: "Zur Startseite" },
    dest: {
      crumb: "Reiseziele",
  ...
  en: {
    ...
    pay: { title: "Pay online", note: "Secure payment by card, TWINT, Apple Pay or Google Pay via Stripe.", cta: "Continue to payment", success: "Payment successful", successText: "Thank you! Your payment has been received. We are checking availability and will confirm within 15 minutes. If we cannot accept the ride, the full amount is refunded immediately.", canceled: "Payment canceled – your request was not completed." },
    ...
    done: { title: "Request submitted!", body: (r: string) => `Your transfer request ${r} has reached us. We are checking availability and will get back to you by e-mail or phone, usually within 15 minutes.`, hint: "Thank you for your request! Please also check your inbox or spam folder.", payment: "Payment method", home: "Back to homepage" },
    dest: {
      crumb: "Destinations",
