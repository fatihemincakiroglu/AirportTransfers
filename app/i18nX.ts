...
const baseX = {
  de: {
    ...
    pay: { title: "Online bezahlen", note: "Sichere Zahlung mit Karte, TWINT, Apple Pay oder Google Pay über Stripe.", cta: "Zur Zahlung", success: "Zahlung erfolgreich", successText: "Vielen Dank! Ihre Zahlung ist eingegangen. Wir prüfen die Verfügbarkeit und bestätigen in der Regel innerhalb von 2 Minuten. Bei einer Absage wird der Betrag sofort vollständig zurückerstattet.", canceled: "Zahlung abgebrochen – Ihre Anfrage wurde nicht abgeschlossen." },
    ...
    dest: {
      ...
      searchPh: "Ort suchen …",
      fixed: "Festpreis", onRequest: "Preis nach Kilometertarif",
      ...
      routeKnown: (n: string) => `Festpreis Flughafen Zürich → ${n} pro Fahrzeug – nach Kilometertarif, inkl. MwSt.`,
  ...
  en: {
    ...
    dest: {
      ...
      fixed: "Fixed price", onRequest: "Price by kilometre tariff",
      ...
      routeKnown: (n: string) => `Fixed price Zurich Airport → ${n} per vehicle – by kilometre tariff, incl. VAT.`,
