...
export const routePosts: BlogPost[] = [
  // ── Fiyat / karşılaştırma ──────────────────────────────────
  {
    ...
    de: {
      ...
      excerpt: "Festpreis nach Kilometertarif, rund 1 Stunde 45 Minuten Fahrt, Tür-zu-Tür ohne Umsteigen: Der ehrliche Vergleich für die Strecke Zürich Flughafen–Basel – für Messebesucher, Familien und Pharma-Reisende.",
      body: [
        { p: [
    ...
    en: {
      ...
      excerpt: "Fixed price at a fixed price by kilometre tariff, around 1 hour 45 minutes, door to door without changes: the honest comparison for the Zurich Airport–Basel route – for trade-fair visitors, families and pharma travellers.",
      body: [
        { p: [
        ...
        { h: "Price: fixed per vehicle, no surprises", p: [
          "Our [Zurich Airport–Basel transfer](/zurich-airport-to-basel) has a fixed price by kilometre tariff in the Business Class (Mercedes-Benz E-Class, up to 2 people and 2 suitcases) – per vehicle, not per person, including VAT, meet & greet in the arrivals hall, 60 minutes of waiting time after landing and flight tracking. For families and groups of up to 7, the booking process shows the Business & Family Class (V-Class) price transparently; for maximum comfort choose the Premium Class (S-Class). All vehicle classes are on the [vehicles page](/fahrzeuge), the full price list on the [prices page](/preise).",
...

  {
    ...
    de: {
      ...
      excerpt: "Rund 2 Stunden 20 Minuten über die A1, Festpreis nach Kilometertarif pro Fahrzeug, Tür zu Tür in die UNESCO-Altstadt oder ins Bundeshaus-Viertel: So planen Sie den Transfer nach Bern.",
      body: [
        { p: [
        ...
        { h: "Preis und Fahrzeit", p: [
          "Der [Transfer Flughafen Zürich–Bern](/zurich-airport-to-bern) hat in der Business Class einen Festpreis nach Kilometertarif, pro Fahrzeug – für die 117 km lange Strecke über die A1 mit einer Fahrzeit von rund 141 Minuten bei normalem Verkehr. Im Preis enthalten: Meet & Greet, 60 Minuten Wartezeit nach der Landung, Flugverfolgung, Kindersitze und Mehrwertsteuer. Grössere Gruppen bis 7 Personen wählen im Buchungsprozess die Business & Family Class; die Details zu allen Klassen stehen auf der [Fahrzeugseite](/fahrzeuge).",
        ]},
    ...
    en: {
      ...
      excerpt: "Around 2 hours 20 minutes via the A1, fixed price by kilometre tariff per vehicle, door to door into the UNESCO old town or the parliament district: how to plan the transfer to Bern.",
      body: [
        { p: [
        ...
        { h: "Price and driving time", p: [
          "The [Zurich Airport–Bern transfer](/zurich-airport-to-bern) has a fixed price by kilometre tariff, per vehicle, in the Business Class – for the 117 km route via the A1 with a driving time of around 141 minutes in normal traffic. Included: meet & greet, 60 minutes of waiting time after landing, flight tracking, child seats and VAT. Larger groups of up to 7 choose the Business & Family Class in the booking process; details of all classes are on the [vehicles page](/fahrzeuge).",
        ]},
...

  {
    ...
    img: "/gallery/17.jpg",
    de: {
      title: "Flughafen Zürich–Luzern: Festpreis nach Kilometertarif, rund 75 Minuten, direkt ans Seeufer",
      ...
      body: [
        ...
        { h: "Preis und Fahrzeit", p: [
          "Unser [Transfer Flughafen Zürich–Luzern](/zurich-airport-to-luzern) hat in der Business Class einen Festpreis nach Kilometertarif, pro Fahrzeug. Die 63 km lange Strecke über die A4 und A14 dauert bei normalem Verkehr rund 76 Minuten. Enthalten sind Meet & Greet in der Ankunftshalle, 60 Minuten Wartezeit nach der Landung, Flugverfolgung, Kindersitze und Mehrwertsteuer. Für bis zu 7 Personen zeigt der Buchungsprozess den Preis der Business & Family Class – wie sich das im Vergleich zu zwei Taxis rechnet, zeigt unser Beitrag [5 bis 7 Personen ab Flughafen Zürich](/blog/gruppen-5-7-personen-flughafen-zuerich-ein-fahrzeug).",
        ]},
...

  {
    ...
    de: {
      ...
      excerpt: "Rund 1 Stunde 40 Minuten über die A1, Festpreis nach Kilometertarif pro Fahrzeug, Tür zu Tür zur Olma, zur Universität oder ins Appenzellerland: Der Guide für die Strecke nach St. Gallen.",
      body: [
        { p: [
        ...
        { h: "Preis und Fahrzeit", p: [
          "Der [Transfer Flughafen Zürich–St. Gallen](/zurich-airport-to-st-gallen) hat in der Business Class einen Festpreis nach Kilometertarif, pro Fahrzeug. Die 81 km über die A1 via Winterthur und Wil dauern bei normalem Verkehr rund 97 Minuten. Enthalten sind Meet & Greet, 60 Minuten Wartezeit nach der Landung, Flugverfolgung, Kindersitze und Mehrwertsteuer. Alle Preise und Klassen: [Preisseite](/preise).",
        ]},
    ...
    en: {
      ...
      excerpt: "Around 1 hour 40 minutes via the A1, fixed price by kilometre tariff per vehicle, door to door to the Olma fair, the university or the Appenzell region: the guide to the St. Gallen route.",
      body: [
        { p: [
    ...
    en: {
      ...
      body: [
        ...
        { h: "Getting there and duration", p: [
          "The 49 km from the airport run north via the A4; we plan around 59 minutes. The fixed price for the Schaffhausen route is calculated by kilometre tariff, per vehicle; the Rhine Falls are right on the way. For an excursion with waiting time and a return to the airport or the city, our hourly booking is the right format: vehicle and chauffeur are at your disposal for the desired duration, the luggage stays in the boot.",
        ]},
...

  {
    ...
    de: {
      ...
      excerpt: "Rund 4 Stunden 15 Minuten, Festpreis nach Kilometertarif pro Fahrzeug, Julier oder Vereina: Wie der Transfer nach St. Moritz, Pontresina, Silvaplana und Sils im Winter zuverlässig funktioniert.",
      body: [
        { p: [
    ...
    en: {
      ...
      excerpt: "Around 4 hours 15 minutes, fixed price by kilometre tariff per vehicle, Julier or Vereina: how the transfer to St. Moritz, Pontresina, Silvaplana and Sils works reliably in winter.",
      body: [
        { p: [
        ...
        { h: "Route, duration, price", p: [
          "The [Zurich Airport–St. Moritz transfer](/zurich-airport-to-st-moritz) runs via the A3 and A13 through the Rhine Valley to Chur, then via Thusis and the Julier Pass into the Engadin. In normal traffic we plan around 255 minutes. The fixed price is calculated by kilometre tariff, per vehicle, including 60 minutes of waiting time after landing, flight tracking, child seats and VAT. For Pontresina, Silvaplana, Sils, Celerina or Samedan simply enter the address in the booking form; we confirm the price before booking.",
        ]},
