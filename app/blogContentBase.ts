    ...
    de: {
      ...
      body: [
        ...
        { h: "Die Strecke ausserhalb der WEF-Woche", p: [
          "Normalerweise dauert der [Transfer Flughafen Zürich–Davos](/zurich-airport-to-davos) über die A3 und A13 via Landquart und die Prättigauerstrasse rund 3 Stunden 15 Minuten; der Festpreis beginnt in der Business Class bei CHF 472.20 pro Fahrzeug. Während des WEF gelten für die letzte Etappe andere Regeln.",
        ]},
    ...
    en: {
      ...
      body: [
        ...
        { h: "The route outside WEF week", p: [
          "Normally the [Zurich Airport–Davos transfer](/zurich-airport-to-davos) via the A3 and A13 through Landquart and the Prättigau road takes around 3 hours 15 minutes; the fixed price starts at CHF 472.20 per vehicle in the Business Class. During the WEF, different rules apply to the final stage.",
        ]},
    ...
    en: {
      ...
      body: [
        ...
        { h: "How a fixed price is made", p: [
          "Each of our fixed routes has a price calculated from distance, typical driving time including the return leg, vehicle class and the included services – not from what happens in traffic on a particular day. Examples from the Business Class: [Winterthur](/zurich-airport-to-winterthur) from CHF 109.88, [Zug](/zurich-airport-to-zug) from CHF 144.36, [Lucerne](/zurich-airport-to-luzern) from CHF 197.24, [Basel](/zurich-airport-to-basel) from CHF 261.36. The full list is on the [prices page](/preise); for addresses outside the fixed routes we confirm the price individually before you book.",
        ]},
    ...
    de: {
      ...
      body: [
        ...
        { h: "Anreise: 75 Minuten ab Flughafen", p: [
          "Der [Transfer Flughafen Zürich–Luzern](/zurich-airport-to-luzern) dauert rund 76 Minuten über die A4 und A14; Festpreis ab CHF 197.24 pro Fahrzeug, Business Class. Ab Zürich Innenstadt ist es etwa eine Stunde. Für den Tagesausflug mit Rückfahrt empfehlen wir die Stundenbuchung: Fahrzeug und Chauffeur bleiben den ganzen Tag bei Ihnen, das Gepäck im Kofferraum. Was Luzern als Ausgangspunkt sonst bietet, steht in [Flughafen Zürich–Luzern im Detail](/blog/flughafen-zuerich-luzern-transfer-preis-dauer).",
        ]},
