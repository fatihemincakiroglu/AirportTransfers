    ...
    de: {
      ...
      body: [
        ...
        { h: "Anreise: 75 Minuten ab Flughafen", p: [
          "Der [Transfer Flughafen Zürich–Luzern](/zurich-airport-to-luzern) dauert rund 76 Minuten über die A4 und A14; Festpreis ab CHF 189.75 pro Fahrzeug, Business Class. Ab Zürich Innenstadt ist es etwa eine Stunde. Für den Tagesausflug mit Rückfahrt empfehlen wir die Stundenbuchung: Fahrzeug und Chauffeur bleiben den ganzen Tag bei Ihnen, das Gepäck im Kofferraum. Was Luzern als Ausgangspunkt sonst bietet, steht in [Flughafen Zürich–Luzern im Detail](/blog/flughafen-zuerich-luzern-transfer-preis-dauer).",
        ]},
