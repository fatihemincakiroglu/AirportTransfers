    ...
    return (
      <div className="min-h-screen" style={{ background: C.ivory, color: C.ink }}>
        ...
        <div className="mx-auto max-w-3xl px-5 py-24 text-center">
          ...
          <a href="/strecken" className="mt-4 inline-block font-bold underline" style={{ color: C.gold }}>
            {D.allRoutes} →
          </a>
        </div>
        <SiteFooter compact />
      ...
      <section style={{ background: C.pine }} className="text-white">
        <div className="mx-auto max-w-7xl px-5 pb-10 pt-8">
          <nav className="flex flex-wrap items-center gap-2 text-sm text-white/60">
            ...
            <a href="/strecken" className="hover:text-white">{L.nav.routes}</a><span>/</span>
      ...
      <div className="mx-auto max-w-4xl px-5 py-14 md:py-20">
        ...
        <div className="mt-12">
          <div className="flex items-end justify-between gap-3">
            ...
            <a href="/strecken" className="text-[12px] font-extrabold uppercase tracking-[0.15em] hover:underline" style={{ color: C.gold }}>
              {L.routesSec.all} →
            </a>
          </div>
